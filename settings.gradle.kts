...
include("msa-enum-handle")
include("mutex")
include("rsa")
include("static-time")
include("front-compiler-annotation-plugin")
include("annotation-processor-maker")
include("annotation-holder")
include("archunit-practice")
include("hibernate-interceptor-slow-query")
include("long-transaction")
include("humongous-object")
